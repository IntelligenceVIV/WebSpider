...
class RandomUserAgentMiddleware():
    def __init__(self):
        self.user_agents = [
            ...
            'Mozilla/5.0 (X11; Linux i686) AppleWebKit/5361 (KHTML, like Gecko) Chrome/44.0.886.0 Safari/5361',
            'Opera/8.12.(Windows NT 5.01; shs-CA) Presto/2.9.164 Version/10.00',
